	...
	<div class="container-fluid">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<ul>
						<li><a href="users.php" style="text-decoration: none;">Users</a></li>
						<li><a href="admin.php" class="active" style="text-decoration: none;">Admin</a></li>
					</ul>
				</div>
			</div>
		</div>		
			...
			<div class="row">
				<div class="col-sm-12">
					<table class="table table-bordered">
						...
						$query1 = "SELECT * FROM tbl_admin ORDER BY id";
						...
						while ($row1=mysqli_fetch_array($res1)) {
							$id = $row1["id"];
							$fullname = $row1["admin_firstname"].' '.$row1["admin_middlename"].' '.$row1["admin_lastname"];
							$username = $row1["admin_username"];
							$pass = $row1["admin_password"];
